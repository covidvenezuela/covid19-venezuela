<template>
  <div id="americaLatina" class="title-map">
    <div class="has-text-centered">
      <h1 class="is-size-2 title-map_h1">
        <strong class="has-text-danger">AMERICA LATINA</strong>
      </h1>
    </div>
    <div class="container is-fullhd">
      <div id="mapAmericaLatinadiv" ref="mapAmericaLatinadiv"></div>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted() {
      // Create map instance
      var chart = am4core.create('mapAmericaLatinadiv', am4maps.MapChart)
      chart.geodataSource.url = '/covid19-venezuela/geojson/latinoamerica_hi.json'
